...
import { Search, MoreVertical, Plus, Edit, Trash2, ListPlus, ScreenShare, Copy, Move, Info } from 'lucide-react';
                  ...
                  {dropdownOpen === item.id && (
                    <div className="absolute right-0 mt-2 w-48 bg-white border rounded-lg shadow-lg z-10">
                      <ul className="py-2 text-gray-700">
                        ...
                        <li className="px-4 py-2 hover:bg-gray-100 flex items-center cursor-pointer">
                          <ScreenShare className="w-4 h-4 mr-2" /> Set to Screen
                        </li>
                        <li className="px-4 py-2 hover:bg-gray-100 flex items-center cursor-pointer">
                        ...
                        <li className="px-4 py-2 hover:bg-gray-100 flex items-center cursor-pointer">
                          <Info className="w-4 h-4 mr-2" /> Item Details
                        </li>
                        <li className="px-4 py-2 hover:bg-red-100 text-red-600 flex items-center cursor-pointer">
