...
const mockWebPages = [
    { id: 1, name: 'Krispy Kreme', address: '', modified: 'May 28, 2024 - 08:44 AM', tags: '' },
    { id: 2, name: 'google.com', address: 'www.google.com', modified: 'May 28, 2024 - 08:44 AM', tags: '' },
    { id: 3, name: 'CNN website', address: 'cnn.com', modified: 'May 28, 2024 - 08:44 AM', tags: '' },
];
                    ...
                    {mockWebPages.map((page) => (
                        <tr key={page.id} className="hover:bg-gray-50">
                            ...
                            <td className="px-6 py-4 text-blue-600">
                                <a href={`http://${page.address}`} target="_blank" rel="noopener noreferrer">
                                    {page.address}
                                </a>
                            </td>
                            <td className="px-6 py-4">{page.modified}</td>
                            <td className="px-6 py-4">{page.tags}</td>
